...
lsp_zero.on_attach(function(client, bufnr)
  ...
  vim.keymap.set("n", "J", function() vim.lsp.buf.definition() end, opts)
  ...
  vim.keymap.set("n", "<leader>hh", function() vim.lsp.buf.code_action() end, opts)
...
require('mason-lspconfig').setup({
  ensure_installed = {'rust_analyzer', 'biome', 'ts_ls', 'jenkins_pipeline_linter_connector'},
  handlers = {
